...
func GetAllAnimeList() []models.Anime {
	animeList := make([]models.Anime, 0)
...
func GetNewAnimeList() []models.NewAnime {
	animeList := make([]models.NewAnime, 0)
