...
type DownloadQueue struct {
	...
	NumberOfChunk int64  `boil:"numberOfChunk" json:"numberOfChunk" toml:"numberOfChunk" yaml:"numberOfChunk"`
...
var DownloadQueueWhere = struct {
	...
	NumberOfChunk whereHelperint64
}{
	...
	NumberOfChunk: whereHelperint64{field: "\"downloadQueue\".\"numberOfChunk\""},
}
...
var (
	downloadQueueAllColumns            = []string{"sn", "name", "ep", "sequence", "downloading", "stop", "spacial", "numberOfChunk"}
	downloadQueueColumnsWithoutDefault = []string{"name", "ep", "sequence"}
	downloadQueueColumnsWithDefault    = []string{"sn", "downloading", "stop", "spacial", "numberOfChunk"}
