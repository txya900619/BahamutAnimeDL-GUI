...
var (
	downloadedAnimationAllColumns            = []string{"id", "title", "part"}
	downloadedAnimationColumnsWithoutDefault = []string{}
	downloadedAnimationColumnsWithDefault    = []string{"id", "title", "part"}
	downloadedAnimationPrimaryKeyColumns     = []string{"id"}
)
...
func FindDownloadedAnimation(ctx context.Context, exec boil.ContextExecutor, iD null.Int64, selectCols ...string) (*DownloadedAnimation, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"downloadedAnimations\" where \"id\"=?", sel,
	)
...
func (o *DownloadedAnimation) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"downloadedAnimations\" WHERE \"id\"=?"
...
func (o *DownloadedAnimation) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindDownloadedAnimation(ctx, exec, o.ID)
	if err != nil {
		return err
	}
...
func DownloadedAnimationExists(ctx context.Context, exec boil.ContextExecutor, iD null.Int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"downloadedAnimations\" where \"id\"=? limit 1)"
